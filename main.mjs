  ...
  try {
    switch (action) {
      ...
      case "new-investment":
        investmentDialog();
        break;
      case 'report-category-detail': openReportCategory(id); break;
